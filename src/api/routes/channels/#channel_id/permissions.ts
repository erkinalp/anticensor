...
router.put(
	...
	async (req: Request, res: Response) => {
		...
		overwrite.allow = String((req.permission?.bitfield || BigInt(0)) & (BigInt(body.allow) || BigInt("0")));
		overwrite.deny = String((req.permission?.bitfield || BigInt(0)) & (BigInt(body.deny) || BigInt("0")));
