...
export class ConnectedAccountDTO {
	...
	constructor(connectedAccount: ConnectedAccount, with_token: boolean = false, viewerUserId?: string) {
	...
	static createPublicDTO(connectedAccount: ConnectedAccount, viewerUserId: string, targetUserId: string): ConnectedAccountDTO | null {
